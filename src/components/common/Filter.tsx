...
type FilterProps = {
    ...
    filterFieldsWithChildMenu: IFilterMenu[];
    onApplyFilter(menu: IFilterMenu[]): void;
    onResetFilter(): void;
    onFilterChange(menu: IFilterMenu[]): void;
...
export const Filter = ({
    ...
    const onApply = () => {
        onApplyFilter(getSelectedFilters());
        setFilterState(!isFilterOpen);
    };
    ...
    const renderChileMenus = (selectedMenu: IFilterMenu) => {
        return (
            <>
                <div className="child-menu-label">{childFilterHeaderLabel}</div>
